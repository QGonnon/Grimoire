...
export const ACTIVE_TASKS: ActiveTaskDef[] = [
  ...
  // ---------- Choix moraux : altèrent vertu/corruption ----------
  {
    id: 'swindle_merchant',
    name: 'Escroquer un marchand',
    description: 'Truquer une transaction pour empocher la différence.',
    resource: 'gold',
    baseAmount: 20,
    cost: { energy: 6 },
    cooldown: 6,
  ...
  {
    id: 'loot_grave',
    name: 'Piller une sépulture',
    description: 'Profaner une tombe pour en tirer des ossements exploitables.',
    resource: 'bones',
    baseAmount: 3,
    cost: { energy: 8 },
    cooldown: 8,
  ...
  },
  {
    id: 'give_alms',
    name: "Faire l'aumône",
    description: 'Partager votre or avec les plus démunis de la ville.',
    resource: 'research',
    baseAmount: 1,
    cost: { gold: 15 },
    cooldown: 6,
  ...
  {
    id: 'do_penance',
    name: 'Faire pénitence',
    description: 'Vous recueillir en silence pour apaiser votre conscience.',
    resource: 'mana',
    baseAmount: 2,
    cost: { energy: 10 },
    cooldown: 10,
